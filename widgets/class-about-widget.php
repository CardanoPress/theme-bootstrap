...
/**
 * CardanoPress Bootstrap About widget
 *
 * @package CardanoPress Bootstrap
 * @since 0.1.0
 */

class CardanoPress_Bootstrap_About_Widget extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'cardanopress_bootstrap_about',
			'description' => __( 'Display site logo and info.', 'cardanopress-bootstrap' ),
		);
		parent::__construct( 'cardanopress_bootstrap_about', 'CardanoPress Bootstrap: About', $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'logo_url' ) ); ?>"><?php _e( 'Logo URL:', 'cardanopress-bootstrap' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'info_text' ) ); ?>"><?php _e( 'Info Text:', 'cardanopress-bootstrap' ); ?></label>
